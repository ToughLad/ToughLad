...
_C/C++, RT Linux, telemetry, PLC/gateway integrations_  
• Built real-time control modules with watchdogs & bounded queues; reduced jitter on critical I/O paths and improved recovery characteristics.

**Backend → Backend Software Engineer — [IVC Valves](https://ivc-valves.com)**  
_Go, TypeScript, PostgreSQL, Redis, MQTT, CI/CD_  
...
_Rust, Go, C++, Linux, networking_  
• 20+ deliveries (top-rated): performance audits, backend rewrites, observability rollouts, protocol work; clear before/after docs.
...
## Contact
**Email:** hello@toughlad.dev · **Site:** https://toughlad.dev · **LinkedIn:** https://www.linkedin.com/in/toughlad/
